...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_TURBO3_0 = 41, // TurboQuant 3-bit (MSE-only PolarQuant, block size 32)
        GGML_TYPE_TURBO4_0 = 42, // TurboQuant 4-bit (3-bit PolarQuant + 1-bit QJL, block size 128)
        GGML_TYPE_COUNT   = 43,
    };
